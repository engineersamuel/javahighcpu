  ...
  for (i = 0, len = ref.length; i < len; i++) {
    ...
    try {
      ...
      if (fullTimeRe.test(line)) {
        ...
        testDate = new Date((ref1 = fullTimeRe1.exec(line)) != null ? ref1[1] : void 0);
        if (!isValidDate(testDate)) {
          testDate = (ref2 = moment((ref3 = fullTimeRe1.exec(line)) != null ? ref3[1] : void 0, "MMM D HH:mm:ss ZZ YYYY")) != null ? typeof ref2.toDate === "function" ? ref2.toDate() : void 0 : void 0;
        }
      }
