...
parseTop = function(topOutput, opts) {
  var cpu, cpuLoc, cpuThreshold, error, fileLine, hexpid, i, idg, javaProcessLoc, ldavg_match, len, line, mem_match, newDate, oldDate, output, percentUsed, pid, pidLoc, ref, ref1, ref2, ref3, ref4, ref5, swap_match, syg, testDate, totalMem, totalSwap, usedMem, usedSwap, usg, words;
