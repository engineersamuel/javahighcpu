...
parseThreadDumps = function(threadDumps) {
  var dateTimeRe, error, extractedDateTime, fileLine, fullTimeRe, i, len, line, lineNum, newDate, oldDate, output, ref, ref1, ref2, splitThreadDump, stackId, testDate;
  output = {};
  ...
  for (i = 0, len = splitThreadDump.length; i < len; i++) {
    ...
    if (fullTimeRe.test(line) || dateTimeRe.test(line)) {
      ...
      try {
        extractedDateTime = ((ref = fullTimeRe.exec(line)) != null ? ref[0] : void 0) || ((ref1 = dateTimeRe.exec(line)) != null ? ref1[0] : void 0);
    ...
    } else if (newDate && (((ref2 = output[+newDate]) != null ? ref2[stackId] : void 0) != null)) {
