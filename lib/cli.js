#!/usr/bin/env node;
var cli, colors, cpuThreshold, d, error, fs, javahighcpu, meow, obj, offenders, parseThreadDumps, parseTop, parsedThreadDumps, parsedTop, pid, proc, processes, ref, ref1, thread, threadLengthDisplay, timestamp,
